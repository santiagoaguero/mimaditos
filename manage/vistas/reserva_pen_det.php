...
<div class="forms">
    ...
    ?>
        ...
        <form class="row g-3 shadow confirmarReserva" method="POST" action="./php/reserva_pen_confirmar.php" autocomplete="off">
        <?php 
        ...
        ?>
            ...
            <input type="hidden" name="confirmar" value="<?php echo $datos["turno_id"] ;?>" required >
